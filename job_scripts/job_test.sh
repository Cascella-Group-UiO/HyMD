...
mkdir ${SCRATCH}
cd ${SCRATCH}
cp /cluster/home/samiransen23/hymdlatest/configABold.toml $SCRATCH/config.toml
cp /cluster/home/samiransen23/hymdlatest/ABinZmedwithmolecules.h5 $SCRATCH/input.h5
mkdir hymd/
