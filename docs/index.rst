...
We welcome contributions from you and provide some community guidelines (`github.com/Cascella-Group-UiO/HyMD/blob/main/CONTRIBUTING.md`_) in the GitHub repository.  
To seek support in case of any issues and bugs, we welcome you to post them using the 
issue tracker (`github.com/Cascella-Group-UiO/HyMD/issues`_) in our GitHub repository. 
