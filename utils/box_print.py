...
x_value = [_[0][0] for _ in list(f["particles/all/box/edges/value"])[first_frame:last_frame]]
y_value = [_[1][1] for _ in list(f["particles/all/box/edges/value"])[first_frame:last_frame]]
z_value = [_[2][2] for _ in list(f["particles/all/box/edges/value"])[first_frame:last_frame]]
