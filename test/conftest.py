    ...
    itp_topol = {
            ...
            "DPPC": {
                ...
                "bonds": [
                    ...
                    [ 3,  5, 1, 0.47, 1250.0],
                    [ 4,  9, 1, 0.47, 1250.0], 
                    [ 5,  6, 1, 0.47, 1250.0], # Weird 
                    [ 9, 10, 1, 0.47, 1250.0], # ordering
                    [ 6,  7, 1, 0.47, 1250.0], # due to 
                    [ 7,  8, 1, 0.47, 1250.0], # type based
                    [10, 11, 1, 0.47, 1250.0], # connectivity
                    [11, 12, 1, 0.47, 1250.0],
                ],
                "angles": [
                    [ 2,  3, 4,  1, 120.0, 25.0],
                    ...
                    [ 4,  9, 10, 1, 180.0, 25.0], 
                    [ 5,  6, 7,  1, 180.0, 25.0],
                    [ 9, 10, 11, 1, 180.0, 25.0], # Type based returns 
                    [ 6,  7, 8,  1, 180.0, 25.0], # his order
